...
const hasFruits = computed(() => {
  return (item: any) => item.fruits && item.fruits.length > 0;
});
...
const getCategoryButtonClass = (category: string) => {
  const baseClass = 'px-8 py-3 rounded-full font-bold text-sm transition-all duration-300 transform hover:scale-105';
  const activeClass = 'bg-gradient-to-r from-brand-gold to-yellow-500 text-black shadow-lg shadow-brand-gold/30';
  const inactiveClass = 'bg-gray-800/80 backdrop-blur-sm text-gray-200 hover:bg-gray-700/80 border border-gray-600 hover:border-brand-gold/50';
  
  return [baseClass, selectedCategory.value === category ? activeClass : inactiveClass];
};
</script>
...
<template>
  <div
    ...
    <div class="absolute inset-0 opacity-10">
      <div
        class="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(255,215,0,0.1),transparent_50%)]"></div>
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-300 max-w-2xl mx-auto mb-4">
          Cada creación está elaborada con pasión y los mejores ingredientes
          para ofrecerte momentos inolvidables de placer dulce
        </p>
        ...
        <div
          ...
          <CommonCardComponent
            ...
            <div
              ...
              <div
                class="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-brand-gold/10 to-transparent rounded-full -translate-y-10 translate-x-10"></div>
              ...
              <div class="mb-4 relative z-10">
                ...
                <div class="space-y-2">
                  <div
                    ...
                    <div
                      class="w-1.5 h-1.5 bg-brand-gold rounded-full flex-shrink-0"></div>
              ...
              <div
                ...
                <div class="space-y-2">
                  <div
                    ...
                    class="flex items-center gap-2">
                    <div
                      class="w-1.5 h-1.5 bg-green-400 rounded-full flex-shrink-0"></div>
                    <span class="text-sm text-gray-300 leading-relaxed">
                      {{ fruit }}
                    </span>
                  </div>
            ...
            <div
              ...
              <div
                ...
                <div class="flex items-center gap-2">
                  ...
                  <div
                    class="w-1 h-4 bg-gradient-to-b from-brand-gold to-yellow-500 rounded-full opacity-60"></div>
                </div>
              </div>
            </div>

            <div
              class="absolute inset-0 bg-gradient-to-t from-brand-gold/5 via-transparent to-brand-gold/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"></div>
          </CommonCardComponent>
        </div>
      </div>
    </div>
